...
<head>
    ...
    <style>
        ...
        .credentials { background: white; padding: 15px; margin: 20px 0; border-left: 4px solid #667eea; font-family: monospace; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="credentials">
                <p><span class="label">Identifiant :</span> {{ $user->identifier }}</p>
