...
if ($actesList instanceof \Illuminate\Database\Eloquent\Collection) {
$actesList = $actesList->all();
}
...
$allClasses = array_unique(array_filter(array_map(fn($c) => $c['member1Classe'] ?? '', $couples)));
