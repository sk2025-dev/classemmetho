...
$typeKey = strtolower((string) ($acte->type_acte ?? $acte->type_annonce ?? $details['type_annonce'] ?? ActeLiturgique::TYPE_GRACE));

if ($typeKey === ActeLiturgique::TYPE_GENERALE) {
$typeActe = 'Annonce générale';
$titreDocument = 'Annonce générale';
$objet = 'Annonce générale';
} else {
$typeActe = 'Action de grâce';
$titreDocument = 'Action de grâce';
$objet = 'Action de grâce';
}
