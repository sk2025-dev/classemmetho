                            ...
                            <div className="px-6 pb-6 grid grid-cols-3 gap-4">
                                {menuItems.map((item, index) => (
                                    <Link
                                        ...
                                        className="group flex flex-col items-center gap-2 p-4 rounded-xl text-center transition-all duration-200 hover:bg-gray-50"
                                    >
                                        <div className={`w-12 h-12 rounded-full ${item.color} flex items-center justify-center text-white transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg`}>
                                            {item.icon}
                                        </div>
                                        ...
                                        <p className="text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-200 line-clamp-2">
                                            {item.subtitle}
                                        </p>
                                    </Link>
                                ))}
