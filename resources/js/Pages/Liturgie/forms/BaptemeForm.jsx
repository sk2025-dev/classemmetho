                        ...
                        {!success ? (
                                    ...
                                    <Field label="Date de naissance">
                                        ...
                                        {currentMember && currentMember.date_naissance && (
                                            <p style={{ fontSize: 12, color: "#16a34a", marginTop: 4 }}>
                                                ✓ Chargée depuis votre profil
                                            </p>
                                        )}
                                        {currentMember && !currentMember.date_naissance && (
                                            <p style={{ fontSize: 12, color: "#d97706", marginTop: 4 }}>
                                                ⚠️ Non renseignée dans votre profil — veuillez la saisir
                                            </p>
                                        )}
                                    </Field>
                                </div>
                            ...
                            <section className="text-center py-12">
                                ...
                                <h2 className="text-3xl font-semibold text-slate-800 mb-2">
                                    Inscription soumise avec succés
                                </h2>
                                <p className="text-slate-600 max-w-md mx-auto">
                                    Votre inscription de baptême a été transmise à votre conducteur. Vous serez notifie à chaque étape.
                                </p>
                                {successMsg && (
