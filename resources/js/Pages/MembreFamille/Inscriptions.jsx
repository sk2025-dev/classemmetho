                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                        <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6">
                            <div className="flex items-start justify-between">
                                <h3 className="text-lg font-bold">Détails de {selectedMember.prenom} {selectedMember.nom}</h3>
                                <button onClick={() => setSelectedMember(null)} className="text-gray-500 hover:text-gray-700">Fermer</button>
                            </div>
                            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{selectedMember.telephone || '—'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-600">Ville</p>
                                    <p className="font-medium">{selectedMember.ville_name || '—'}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{selectedMember.fonction_name || '—'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-600">Date de naissance</p>
                                    <p className="font-medium">{selectedMember.date_naissance || '—'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
