    ...
    const menuItems = [
        {
            ...
            icon: "inscription",
            href: "/membre-famille/inscriptions",
            color: "text-blue-600",
            bg: "bg-blue-100",
        },
        ...(auth?.user?.classe?.has_tribus
            ? [
                  {
                      title: "Tribu",
                      desc: "Votre tribu et son suivi",
                      icon: "tribu",
                      href: "/membre-famille/tribu",
        ...
        },
        {
            ...
            icon: "programme",
            href: "/membre-famille/programmes",
            color: "text-red-600",
            bg: "bg-red-100",
        },
        {
