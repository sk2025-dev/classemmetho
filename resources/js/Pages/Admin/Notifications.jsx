            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        ...
                        {notifications.total !== 1 ? "s" : ""} envoyée
                ...
                {notifications.data.length === 0 ? (
                    <div className="bg-white rounded-lg shadow-lg p-12 text-center">
                        ...
                        <p className="text-gray-600">
                            Les notifications apparaîtront ici quand vous
                            approuverez des inscriptions.
                        </p>
                    </div>
                ) : (
                    /* Notifications List */
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <span
                                                    className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getChannelColor(notification.channel)}`}
                                                >
