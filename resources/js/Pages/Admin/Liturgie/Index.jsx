                                            ...
                                            <div className="d-actions">
                                                ...
                                                {DONE.includes(acte.statut) && (
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            window.open(
                                                                `/admin/liturgie/${acte.id}/certificat`,
                                                                "_blank",
                                                            )
                                                        }
                                                    >
                            ...
                            <div className="ann-hero-left">
                                ...
                                <div>
                                    <div className="ann-hero-title">
                                        Mes annonces paroissiales
                                    </div>
                                    <div className="ann-hero-sub">
                                        Partagez avec la communauté · Validé par
                                        conducteur puis pasteur · Fiche PDF
                                        disponible
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="modal-body">
                            ...
                            {VALID.includes(selectedAnnonce.statut) && (
                                <button
                                    ...
                                    onClick={() =>
                                        window.open(
                                            `/admin/annonces/${selectedAnnonce.id}/fiche`,
                                            "_blank",
                                        )
                                    }
                                >
