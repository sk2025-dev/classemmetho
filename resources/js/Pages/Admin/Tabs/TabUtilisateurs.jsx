                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex items-start gap-6">
                        <div className="relative shrink-0">
                            {member.photo ? (
                                <img src={member.photo} alt={member.nom} className="w-36 h-36 rounded-full object-cover border-4 border-white shadow-lg ring-2 ring-blue-100" />
                            ) : (
            ...
            <div className="flex flex-col h-full animate-fade-in-up">
                ...
                <div className="glass-panel w-full rounded-2xl p-6 shadow-lg mb-6 border-l-4 border-blue-500">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button onClick={() => window.location.href = 'http://127.0.0.1:8000/admin/inscriptions/type-selection'} className="ml-auto px-4 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold transition flex items-center justify-center gap-2 text-sm shadow-md">
                            ...
                            <tbody className="divide-y divide-gray-100 bg-white/60 backdrop-blur-sm">
                                {currentItems.length > 0 ? currentItems.map((m, idx) => (
                                    <tr key={m.id} className="hover:bg-white/90 transition-all duration-200" style={{
                                        ...
                                        <td className="px-3 py-3 text-sm text-gray-700 text-center whitespace-nowrap">{m.fonction || "-"}</td>
                                        ...
                                        <td className="px-3 py-3 text-sm text-gray-700 text-center whitespace-nowrap">{m.relation || "-"}</td>
                                    ...
                                    <tr>
                                        <td colSpan={23} className="px-6 py-12 text-center text-gray-400 italic">Aucun utilisateur trouvé.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
