...
export default function Selection({
    ...
    const submitAnnonce = async () => {
        ...
        try {
            ...
            closeAnnonce();
            notify("✅ Demande de prière soumise ! Elle sera transmise au Bureau des Conducteurs.");
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-5">
                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                                Soumettre une demande de prière ou d'action de
                                grâce.
                            </p>
                            <div className="inline-flex items-center justify-between w-full text-sm font-semibold text-slate-500">
                                Cliquer pour ouvrir
                        ...
                        <div className="sel-modal-head">
                            <div>
                                ...
                                <div className="sel-modal-sub">
                                    ...
                                    Bureau des Conducteurs → Pasteur →
                                    Publication
                                </div>
                            </div>
                            <button
                        ...
                        <div className="sel-modal-body">
                            ...
                            {annonceStep === 2 && (
                                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                    ...
                                    <div className="sel-card">
                                        <SelField
                                            label="Personne concernée (optionnel)"
                                            icon={<User size={13} />}
                                        >
                                            <Select2Single
                                                name="membre_id"
