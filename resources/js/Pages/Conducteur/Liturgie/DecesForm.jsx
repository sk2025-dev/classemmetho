            ...
            if (selectedMember) {
                setForm((prev) => ({
                    ...
                    details: {
                        ...
                        def_baptise: selectedMember.sacrements?.baptise
                            ? "oui"
                            : "non",
    ...
    const submit = async (e) => {
        ...
        if (form.details.programme_obseques === "oui") {
            const { valid, errors: rowErrors, cleaned } =
                validateProgrammeRows(programmeRows);
            if (!valid) {
                const flat = { submit: "Vérifiez les étapes du programme d'obsèques." };
                Object.entries(rowErrors).forEach(([k, v]) => {
                            ...
                            <section>
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-slate-500 mb-4">
                                        Sélectionnez le membre concerné. Si la
                                        personne décédée n'est pas inscrite,
                                        choisissez "Autre membre".
                                    </p>
                                </div>
                                <div className="bg-slate-50 border border-slate-200 rounded-sm p-4 text-sm text-slate-700 mb-6">
                                    L'église vous présente ses sincères
                                    condoléances et vous accompagne dans cette
                                    épreuve.
                                </div>
                                        ...
                                        <>
                                            <div className="bg-blue-50 border border-blue-200 rounded-sm p-4 mb-6">
                                                ...
                                                <p className="text-xs text-blue-700">
                                                    ...
                                                    proviennent du profil du
                                                    membre. Si vous souhaitez
                                                    déclarer une autre personne,
                                                    sélectionnez "Autre membre".
                                                </p>
                                            </div>
                                    ...
                                    <>
                                        <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded">
                                            <p className="text-xs text-amber-800">
                                                ℹ️ Complétez les informations de
                                                la personne décédée
                                            </p>
                                        </div>
                                            ...
                                            <Field label="Etait membre de l'eglise ?">
                                                ...
                                                >
                                                    ...
                                                    <option value="membre_longue_date">
                                                        Oui, membre de longue
                                                        date
                                                    </option>
                                                    <option value="ami">
                                                        Ami(e) de l'eglise
                                                    </option>
                                                    <option value="non_membre">
                                                        Non membre
                                                    </option>
                                                </select>
                                            </Field>
                                ...
                                <div className="mt-6 rounded-xl border border-slate-200 bg-white p-4">
                                    ...
                                    <Field label="Disposez-vous déjà d'un programme d'obsèques ?">
                                        ...
                                        >
                                            ...
                                            <option value="non">Pas encore (renseigné plus tard)</option>
                                        </select>
                                    </Field>
                                    {form.details.programme_obseques === "non" && (
                                        <p className="mt-2 text-xs italic text-slate-500">
                                            Le programme (dates, veillées, culte, inhumation…) pourra
                                            être ajouté ensuite, tant qu'il n'est pas clôturé.
                                        </p>
                                    )}
