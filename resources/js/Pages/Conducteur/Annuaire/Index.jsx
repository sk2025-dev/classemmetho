...
const Annuaire = ({
    ...
    user = { role: "user" },
    filters = {},
    filterOptions = { classes: [], familles: [], professions: [], roles: [] }, // <-- remplacé statuts par professions
}) => {
    ...
    const applyFilters = useCallback(() => {
        router.get(
            window.location.pathname,
            {
                ...
                profession: professionFilter, // <-- remplace statut
                role: roleFilter,
    ...
    const normalizeMember = (member) => {
        ...
        return {
            ...member,
            prenoms,
            classeMethodiste: toText(
                member?.classeMethodiste || member?.classe,
                "-",
            ),
            famille: toText(
            ...
            dateNaissance:
                member?.dateNaissance || member?.date_naissance || null,
    ...
    // Vue classes avec pagination interne des membres
