    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('FormData contient:', {
                famille,
                responsable: { ...responsable, photo: responsable.photo ? 'File object' : null },
            ...
            if (Object.keys(apiErrors).length > 0) {
                ...
                showError("Une erreur système s'est produite lors du traitement de votre inscription.\n\nNos équipes techniques ont été notifiées. Veuillez réessayer dans quelques instants ou contacter l'administration si le problème persiste.");
            } else if (statusCode >= 400) {
                showError(`Erreur ${statusCode}: Une erreur est survenue lors de la soumission. Veuillez réessayer.`);
            } else {
                showError("Une erreur est survenue lors de la soumission du formulaire. Veuillez réessayer.");
            }
        } finally {
            setLoading(false);
        }
                            ...
                            <FormField label="Fonction dans l'église" icon={Users} hint="Cliquez pour sélectionner">
                                <Select2Fonction
                                        ...
                                        onChange={(e) => {
                                            ...
                                            const ids = new Set(e.target.value);
                                            setSelectedMembresRoles(ids);
                                            setMembreTemp({
                                                ...membreTemp,
                        ...
                        <div className="border-t pt-6 mt-6">
                            ...
                            <div className="space-y-3 mb-4">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm font-semibold text-gray-700">Baptis?(e)</span>
                                </label>
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm font-semibold text-gray-700">Mari?(e) religieusement</span>
                                </label>
                    ...
                    <div className="space-y-6 animate-fadeIn">
                        ...
                        {hasMembersToAdd === true && (
                            ...
                            {membreTemp.statutMarital === "veuf" && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white rounded-lg border border-gray-200">
                                    <FormField label="Date du d?c?s" icon={Calendar} required>
                                        <input
                                            type="date"
                                            className={STYLES.input}
                                    ...
                                    <FormField label="Lieu du d?c?s" icon={Building} required>
                                        <input
                                            className={STYLES.input}
                            ...
                            {step === 3 ? (
                                <>
                                    <button
                                        ...
                                        className={hasMembersToAdd === null ? `${STYLES.button.primary} ml-auto flex items-center gap-2 opacity-40 cursor-not-allowed` : `${STYLES.button.primary} ml-auto flex items-center gap-2 shadow-lg scale-105 transition-transform`}
                                    >
                                        <span>Continuer</span>
