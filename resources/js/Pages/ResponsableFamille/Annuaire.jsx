...
const Annuaire = ({ 
    ...
    const renderFamiliesView = () => {
        if (!families || families.data.length === 0) return <p className="text-center py-12 text-gray-400 italic">Aucune famille trouvée.</p>;
        return (
    ...
    const renderClassesView = () => {
        if (!classes || classes.data.length === 0) return <p className="text-center py-12 text-gray-400 italic">Aucune classe trouvée.</p>;
        return (
                ...
                <div className="w-full">
                    <div className="flex flex-col md:flex-row items-center justify-between mb-6 gap-4 w-full">
                        <div className="w-full md:w-auto flex-shrink-0">
                            <Link href="/ResponsableFamille/dashboard" className="btn btn-secondary gap-2 w-full md:w-auto justify-center">
