...
export default function CreateMember({ family, errors }) {
    ...
    const [data, setData] = usePersistentState('createMember_data', {
        nom: "",
        prenom: "",
        email: "",
        telephone: "",
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-blue-100 text-sm font-medium flex items-center gap-2">
                                Famille : <span className="bg-white/20 px-2 py-0.5 rounded text-xs backdrop-blur-sm">{family.nom}</span>
                            </p>
                        </div>
                    </div>
                </div>
                                                ...
                                                <FormField label="Date de première communion">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setData({
                                                                ...data,
                                                                date_premiere_communion: e.target.value,
                                                            })
                                                        }
                                                    />
                                                </FormField>
                                                <FormField label="Lieu de première communion">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setData({
                                                                ...data,
                                                                lieu_premiere_communion: e.target.value,
                                                            })
                                                        }
                                                        placeholder="ex: Église Saint-Paul"
                                                    />
                                                ...
                                                <FormField label="Date du mariage religieux">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setData({
                                                                ...data,
                                                                date_mariage_religieux: e.target.value,
                                                            })
                                                        }
                                                    />
                                                </FormField>
                                                <FormField label="Lieu du mariage religieux">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setData({
                                                                ...data,
                                                                lieu_mariage_religieux: e.target.value,
                                                            })
                                                        }
                                                        placeholder="ex: Église Saint-Paul"
                                                    />
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end gap-3 bg-gray-50/50 -mx-6 -mb-6 p-6 rounded-b-2xl">
                        ...
                        >
                            {loading ? (
                                ...
                                <><Check className="w-4 h-4" /> Enregistrer le Membre</>
                            )}
                        </button>
                    </div>
