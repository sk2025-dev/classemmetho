...
export default function EditMember({ member, family }) {
    ...
    useEffect(() => {
        ...
        const initialData = {
            ...
            date_premiere_communion: formatDateForInput(currentSacrements.premiere_communion_date),
            lieu_premiere_communion: currentSacrements.premiere_communion_lieu || "",
            marie_religieusement: currentSacrements.marie_religieusement || false,
            date_mariage_religieux: formatDateForInput(currentSacrements.mariage_religieux_date),
            lieu_mariage_religieux: currentSacrements.mariage_religieux_lieu || "",
        };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-white/80 text-sm">Mettez à jour les informations du membre</p>
                    </div>
                </div>
                        ...
                        <section className="space-y-4 p-6 border border-gray-200 rounded-xl bg-gray-50">
                            ...
                            <FormField label="Nom" icon={User} required>
                                <input
                                    ...
                                    value={data.nom}
                                    onChange={(e) => {
                                        const newData = { ...data, nom: e.target.value };
                                        setData(newData);
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end gap-3 bg-gray-50/50 -mx-6 -mb-6 p-6 rounded-b-2xl">
                        ...
                        >
                            {loading ? (
                                ...
                                <><Check className="w-4 h-4" /> Modifier le Membre</>
                            )}
                        </button>
                    </div>
