...
export default function BureauConducteurPrieresIndex({ prayerRequests = [] }) {
    ...
    const updateRequestStatus = (requestId, status, e) => {
        ...
        router.patch(
            withBasePath("", `/bureau-conducteur/prieres/${requestId}/status`),
            { statut: status },
            {
                preserveScroll: true,
                preserveState: true,
    ...
    const toggleReaction = (requestId, commentId, emoji) => {
        router.patch(
            withBasePath("", `/bureau-conducteur/prieres/${requestId}/reaction`),
    ...
    const submitComment = (requestId) => {
        ...
        router.patch(
            withBasePath("", `/bureau-conducteur/prieres/${requestId}/commentaire`),
            {
                commentaire: draft,
    ...
    return (
        <>
            <Head title="Prières - Bureau des Conducteurs" />
