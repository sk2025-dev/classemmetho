...
class UserManagementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = User::with('classe', 'famille', 'fonctions', 'ville', 'sacrements');
        ...
        $formattedUsers = $users->map(function ($user) {
            ...
            return [
                ...
                'fonctions' => $user->fonctions->pluck('nom')->values()->all(),
                'fonction'  => $user->fonctions->pluck('nom')->join(', '),
    ...
    {
        $user = User::with(['family', 'classe', 'ville', 'fonctions', 'sacrements'])->findOrFail($id);
