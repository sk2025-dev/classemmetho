...
class AdminInscriptionsController extends Controller
{
    ...
    public function storeFamily(Request $request)
    {
        ...
        try {
            ...
            $responsableProfession = $validated['responsable']['profession_detail']
                ?? $validated['responsable']['profession']
                ?? null;
            $responsableRelation = $validated['responsable']['relation']
                ?? $validated['responsable']['lienParente']
                ?? null;
            ...
            if (!empty($validated['membres']) && is_array($validated['membres'])) {
                foreach ($validated['membres'] as $index => $membreData) {
                    ...
                    $membre = User::create([
                        ...
                        'profession' => $membreData['profession_detail'] ?? $membreData['profession'] ?? null,
    ...
    public function storeConductor(Request $request)
    {
        ...
        try {
            ...
            $conductor = User::create([
                ...
                'genre' => $validated['responsable']['genre'],
                'employment_status' => $validated['responsable']['employment_status'] ?? null,
                'profession' => $validated['responsable']['profession_detail'] ?? $validated['responsable']['profession'] ?? null,
                'niveau_etude' => $validated['responsable']['niveau_etude'] ?? null,
