...
class RegistrationController extends Controller
{
        ...
        try {
            ...
            return response()->json([
                ...
                'message' => $type === 'conductor'
                    ? '🎉 Excellente nouvelle ! Votre inscription de conducteur a été soumise avec succès. Bienvenue dans notre communauté spirituelle ! En attente de validation par l\'administrateur. Vous recevrez bientôt votre code membre et vos accès de connexion.'
                    : '🎉 Excellente nouvelle ! Votre inscription familiale a été soumise avec succès. Bienvenue dans notre grande famille spirituelle ! En attente de validation par l\'administrateur. Vous recevrez bientôt votre code membre et vos accès de connexion.',
    ...
    public function storeConductor(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => '🎉 Excellente nouvelle ! Votre inscription de conducteur a été soumise avec succès. Bienvenue dans notre communauté spirituelle ! En attente de validation par l\'administrateur. Vous recevrez bientôt votre code membre et vos accès de connexion.',
                'data'    => [
                    'inscription_id'           => $inscription->id,
