        ...
        try {
            ...
            try {
                ...
                ->filter(function ($insc) use ($classIds) {
                    $classeId = $insc->data['famille']['classe_id'] ?? null;
                ...
                $allInscriptions = $allInscriptionsQuery->map(function ($insc) {
                    try {
                        ...
                        $mapped = [
                            ...
                            'nom' => $insc->responsable_nom,
                            'prenom' => $insc->responsable_prenom,
                            ...
                            'status' => $insc->status,
                            'role' => $insc->type === 'famille' ? 'responsable_famille' : ($insc->data['role'] ?? null),
                        ...
                        if ($insc->type === 'famille') {
                            ...
                            $mapped['responsable_fonction'] = $insc->responsable_profession;
                            $mapped['responsable_date_naissance'] = $insc->responsable_date_naissance;
                        ...
                        $mapped['classe_id'] = $insc->data['famille']['classe_id'] ?? $insc->classe_id ?? null;
        ...
        try {
            ...
            try {
                if ($inscription->type === 'famille') {
                    // Pour une famille, créer le responsable + famille + membres immédiatement
                    $approvalService = app(InscriptionApprovalService::class);
                    $approvalService->approve($inscription, $user, 'conducteur');

                    Log::info('Famille approuvée par conducteur', [
