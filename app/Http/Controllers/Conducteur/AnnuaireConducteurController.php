...
class AnnuaireConducteurController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($view === 'all') {
            ...
            return Inertia::render('Conducteur/Annuaire', [
                'members' => $users,
                'view' => 'all',
    ...
    private function transformUser($user)
    {
        return [
            ...
            'dateBapteme' => $user->sacrements?->date_bapteme?->format('Y-m-d'),
            'lieuBapteme' => $user->sacrements?->lieu_bapteme,
            'premiereCommunion' => (bool) ($user->sacrements?->communion ?? false),
            'dateCommunion' => $user->sacrements?->date_communion?->format('Y-m-d'),
            ...
            'dateCreation' => $user->created_at?->format('Y-m-d H:i:s'),
            // Nouveaux champs ajoutés
            'relation' => $user->relation ?? '-',
            'mariageCivil' => (bool) ($user->mariage_civil ?? false),
            'dote' => (bool) ($user->dote ?? false),
            'veuf' => (bool) ($user->veuf ?? false),
